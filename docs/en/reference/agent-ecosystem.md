...
## Where Agent Policy fits

Agent Policy owns decision facts: risk scopes, approvals, permissions, grants, denials, obligations, waivers, redaction, retention, and policy traces.

Policy explains whether an agent action may proceed, under which constraints, and who accepted or rejected the risk.
...
| [Open Policy Agent](https://www.openpolicyagent.org/docs/) | Policy-as-code and decision/enforcement separation. |
| [Cedar](https://docs.cedarpolicy.com/) | PARC authorization model and schema validation. |
| [OASIS XACML 3.0](https://docs.oasis-open.org/xacml/3.0/xacml-3.0-core-spec-os-en.html) | PDP/PEP split and decision vocabulary. |
